...
| --- | ---: | --- |
| [`@broccolo1d/wallet-browser`](packages/wallet-browser/README.md) | `0.2.3` | Core browser automation for MetaMask integration with Chromium context management and wallet state verification. |
| [`@broccolo1d/playwright`](packages/playwright/README.md) | `0.2.3` | Playwright test fixtures and utilities for wallet-integrated dapp testing with structured proof artifacts. |
