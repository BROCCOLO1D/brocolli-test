...
- `@broccolo1d/wallet-browser@0.2.6` — core browser-wallet runtime, guardrails, CLI, and artifact helpers.
- `@broccolo1d/playwright@0.2.6` — Playwright fixtures for downstream dapp QA suites.
